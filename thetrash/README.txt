...
a persistence unit "thetrashPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "thetrash/pom.xml":
...
artifacts ("thetrash-ejb.jar" and "thetrash-web.war") are already built. You can build
